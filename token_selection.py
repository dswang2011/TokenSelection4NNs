...
if __name__ == '__main__':
	...
	token_select.token_selection_preparation(nlp = nlp, dataset="RTE",file_name="train.csv")
	token_select.token_selection_preparation(nlp = nlp, dataset="RTE",file_name="test.csv")
